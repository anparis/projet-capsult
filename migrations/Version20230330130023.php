 ...
 */
final class Version20230330130023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bloc CHANGE slug slug VARCHAR(150) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bloc CHANGE slug slug VARCHAR(150) DEFAULT NULL');
